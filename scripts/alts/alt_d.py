...
DAYS = [
    {
        ...
        'type': 'travel',
        'descr': 'Same as Alt B Day 0: Boise -> Green River -> Hwy 24 S -> Temple Mtn '
                 'Townsite (FCFS) or Goblin Valley SP.',
        'miles': 650,
    ...
    {
        'id': 'altD_day1_swell',
        'label': 'May 3 (Sat) - Day 1: Temple Mtn -> Sinbad -> BTR W -> Crack camp',
        'date_iso': '2026-05-03',
    ...
    {
        'id': 'altD_day2_swell',
        'label': 'May 4 (Sun) - Day 2: Crack -> BTR W + HS Overlook -> Family Butte',
        'date_iso': '2026-05-04',
    ...
    {
        'id': 'altD_day3_swell',
        'label': 'May 5 (Mon) - Day 3: Family Butte -> Wedge (breather)',
        'date_iso': '2026-05-05',
